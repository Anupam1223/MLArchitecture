...
Visualized React slide deck for ML architecture concepts — same architecture as Math for ML.
...
export const meta = { title: 'Transformers', subtitle: 'Attention & scaling' };
